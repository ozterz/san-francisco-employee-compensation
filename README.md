...
This is my final project for Programming in Journalism. I conducted a data analysis on San Francisco's data on their City employee compensation.
...
* `cd san-francisco-employee-compensation`
* `pipenv install`
